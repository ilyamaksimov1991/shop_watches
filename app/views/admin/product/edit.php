 ...
 * @var \app\models\RelatedProductModel $relatedProduct
 * @var \app\models\AttributeProductModel $filter
 * @var \app\models\GalleryModel $gallery
 */
?>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <form action="<?=ADMIN_URL;?>/product/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <?php new \app\widgets\filter\Filter($filter, WIDGETS_DIR . '/filter/admin_filter_tpl.php'); ?>
                        <div class="form-group">
                            <div class="col-md-4">
