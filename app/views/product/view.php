<?php
/**
 * @TODO как правильно foreach оформлять phpdoc om
 * @var array $gallery
 * @var app\models\GalleryModel $item
 * @var array $products
 * @var app\models\ProductModel $product
 * @var array $mods
 * @var app\models\ModificationProductModel $mod
 * @var app\models\ProductModel $related
 * @var app\models\ProductModel $recentlyViewed
 */
?>
        ...
        <div class="single-main">
            <div class="col-md-12 single-main-left">
                <div class="sngl-top">
                    ...
                    <?php
                    $curr = \framework\App::$app->getProperty('currency');
                    ...
                    <div class="col-md-4 tabs ">
                        <ul class="menu_drop">
                            <li class="item1"><a href="#"><img src="images/arrow.png" alt="">Description</a>
                                <ul>
                                    <li class="subitem1"><a href="#">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. onsequat.</a></li>
                                </ul>
                            </li>
